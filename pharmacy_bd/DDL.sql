...
-- DROP SEQUENCE pharmacy.client_client_id_seq;

CREATE SEQUENCE pharmacy.client_client_id_seq
	INCREMENT BY 1
	MINVALUE 1
...
ALTER SEQUENCE pharmacy.client_client_id_seq OWNER TO postgres;
GRANT ALL ON SEQUENCE pharmacy.client_client_id_seq TO postgres;

-- DROP SEQUENCE pharmacy.product_product_id_seq;

CREATE SEQUENCE pharmacy.product_product_id_seq
	INCREMENT BY 1
	MINVALUE 1
	MAXVALUE 9223372036854775807
	START 1
...
ALTER SEQUENCE pharmacy.sale_seq OWNER TO postgres;
GRANT ALL ON SEQUENCE pharmacy.sale_seq TO postgres;
...
ALTER SEQUENCE pharmacy.saledetal_seq OWNER TO postgres;
GRANT ALL ON SEQUENCE pharmacy.saledetal_seq TO postgres;
...
-- DROP SEQUENCE pharmacy.user_seq;

CREATE SEQUENCE pharmacy.user_seq
	INCREMENT BY 50
	MINVALUE 1
	MAXVALUE 9223372036854775807
	START 1
...
ALTER SEQUENCE pharmacy.user_seq OWNER TO postgres;
GRANT ALL ON SEQUENCE pharmacy.user_seq TO postgres;
-- pharmacy.client definition

-- Drop table

-- DROP TABLE pharmacy.client;

CREATE TABLE pharmacy.client ( client_id int8 GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1 NO CYCLE) NOT NULL, client_address varchar(100) NULL, client_city varchar(100) NULL, client_country varchar(100) NULL, client_date date NOT NULL, client_email varchar(100) NULL, client_last_name varchar(100) NOT NULL, client_name varchar(100) NOT NULL, client_phone varchar(100) NULL, client_postal_code varchar(100) NULL, client_state varchar(100) NULL, client_status bool NOT NULL, client_type varchar(100) NULL, CONSTRAINT client_pkey PRIMARY KEY (client_id));

-- Permissions

ALTER TABLE pharmacy.client OWNER TO postgres;
GRANT ALL ON TABLE pharmacy.client TO postgres;
...
-- pharmacy.product definition

-- Drop table

-- DROP TABLE pharmacy.product;

CREATE TABLE pharmacy.product ( product_id int8 GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1 NO CYCLE) NOT NULL, product_catalog int4 NULL, product_code_bar varchar(255) NULL, product_count int4 NULL, product_date date NULL, product_desc varchar(255) NULL, product_lastmdate date NULL, product_lote varchar(255) NULL, product_name varchar(255) NULL, product_price float4 NULL, CONSTRAINT product_pkey PRIMARY KEY (product_id));

-- Permissions

ALTER TABLE pharmacy.product OWNER TO postgres;
GRANT ALL ON TABLE pharmacy.product TO postgres;
...
-- pharmacy.sale definition

-- Drop table

-- DROP TABLE pharmacy.sale;

CREATE TABLE pharmacy.sale ( id int8 NOT NULL, date_sale date NULL, discount float4 NOT NULL, id_sale_detl int8 NOT NULL, iva float4 NOT NULL, msg varchar(255) NULL, payment_method varchar(255) NULL, payment_status varchar(255) NULL, status varchar(255) NULL, sub_total float4 NOT NULL, time_sale time(6) NULL, total float4 NOT NULL, username varchar(255) NULL, CONSTRAINT sale_pkey PRIMARY KEY (id));

-- Permissions

ALTER TABLE pharmacy.sale OWNER TO postgres;
GRANT ALL ON TABLE pharmacy.sale TO postgres;


-- pharmacy.saledetal definition

-- Drop table

-- DROP TABLE pharmacy.saledetal;

CREATE TABLE pharmacy.saledetal ( id int8 NOT NULL, date_sale date NULL, product_code_bar varchar(255) NULL, product_count int8 NULL, product_id int8 NOT NULL, product_price float4 NOT NULL, time_sale time(6) NULL, CONSTRAINT saledetal_pkey PRIMARY KEY (id));

-- Permissions

ALTER TABLE pharmacy.saledetal OWNER TO postgres;
GRANT ALL ON TABLE pharmacy.saledetal TO postgres;
...
-- pharmacy."user" definition

-- Drop table

-- DROP TABLE pharmacy."user";

CREATE TABLE pharmacy."user" ( id int8 NOT NULL, country varchar(255) NULL, firstname varchar(255) NULL, lastname varchar(255) NOT NULL, "password" varchar(255) NULL, "role" varchar(255) NULL, username varchar(255) NOT NULL, CONSTRAINT uksb8bbouer5wak8vyiiy4pf2bx UNIQUE (username), CONSTRAINT user_pkey PRIMARY KEY (id), CONSTRAINT user_role_check CHECK (((role)::text = ANY ((ARRAY['ADMIN'::character varying, 'USER'::character varying, 'CONT'::character varying, 'AUDITOR'::character varying])::text[]))));

-- Permissions

ALTER TABLE pharmacy."user" OWNER TO postgres;
GRANT ALL ON TABLE pharmacy."user" TO postgres;


-- pharmacy.userjwt definition

-- Drop table

-- DROP TABLE pharmacy.userjwt;

CREATE TABLE pharmacy.userjwt ( username varchar(50) NOT NULL, jwt varchar(255) NULL, star_date date NULL, star_time time(6) NULL, CONSTRAINT userjwt_pkey PRIMARY KEY (username));

-- Permissions

ALTER TABLE pharmacy.userjwt OWNER TO postgres;
GRANT ALL ON TABLE pharmacy.userjwt TO postgres;


-- pharmacy.vw_t_best_sellers_30d definition

-- Drop table

-- DROP TABLE pharmacy.vw_t_best_sellers_30d;

CREATE TABLE pharmacy.vw_t_best_sellers_30d ( product_id int8 NULL, sku text NULL, product_name text NULL, qty_sold numeric(14, 4) NULL, revenue numeric(14, 2) NULL, sales_count int8 NULL);

-- Permissions

ALTER TABLE pharmacy.vw_t_best_sellers_30d OWNER TO postgres;
GRANT ALL ON TABLE pharmacy.vw_t_best_sellers_30d TO postgres;


-- pharmacy.vw_t_cash_journal_balance definition

-- Drop table

-- DROP TABLE pharmacy.vw_t_cash_journal_balance;

CREATE TABLE pharmacy.vw_t_cash_journal_balance ( cash_journal_id int8 NULL, "name" text NULL, opening_amount numeric(14, 2) NULL, opened_at timestamptz NULL, closed_at timestamptz NULL, inflow numeric(14, 2) NULL, outflow numeric(14, 2) NULL, balance numeric(14, 2) NULL);

-- Permissions

ALTER TABLE pharmacy.vw_t_cash_journal_balance OWNER TO postgres;
GRANT ALL ON TABLE pharmacy.vw_t_cash_journal_balance TO postgres;


-- pharmacy.vw_t_customer_account_summary definition

-- Drop table

-- DROP TABLE pharmacy.vw_t_customer_account_summary;

CREATE TABLE pharmacy.vw_t_customer_account_summary ( customer_id int8 NULL, customer_name text NULL, total_invoiced numeric(14, 2) NULL, total_paid numeric(14, 2) NULL, balance numeric(14, 2) NULL);

-- Permissions

ALTER TABLE pharmacy.vw_t_customer_account_summary OWNER TO postgres;
GRANT ALL ON TABLE pharmacy.vw_t_customer_account_summary TO postgres;


-- pharmacy.vw_t_customer_invoice_aging definition

-- Drop table

-- DROP TABLE pharmacy.vw_t_customer_invoice_aging;

CREATE TABLE pharmacy.vw_t_customer_invoice_aging ( invoice_id int8 NULL, invoice_no text NULL, customer_id int8 NULL, customer_name text NULL, invoice_date timestamptz NULL, due_date date NULL, paid_amount numeric(14, 2) NULL, outstanding numeric(14, 2) NULL, invoice_status text NULL, days_overdue int4 NULL);

-- Permissions

ALTER TABLE pharmacy.vw_t_customer_invoice_aging OWNER TO postgres;
GRANT ALL ON TABLE pharmacy.vw_t_customer_invoice_aging TO postgres;


-- pharmacy.vw_t_daily_cash_cut definition

-- Drop table

-- DROP TABLE pharmacy.vw_t_daily_cash_cut;

CREATE TABLE pharmacy.vw_t_daily_cash_cut ( "day" timestamptz NULL, sales_cash numeric(14, 2) NULL, sales_non_cash numeric(14, 2) NULL, cash_entries_in numeric(14, 2) NULL, cash_entries_out numeric(14, 2) NULL, net_cash numeric(14, 2) NULL);

-- Permissions

ALTER TABLE pharmacy.vw_t_daily_cash_cut OWNER TO postgres;
GRANT ALL ON TABLE pharmacy.vw_t_daily_cash_cut TO postgres;


-- pharmacy.vw_t_inventory_stock definition

-- Drop table

-- DROP TABLE pharmacy.vw_t_inventory_stock;

CREATE TABLE pharmacy.vw_t_inventory_stock ( product_id int8 NULL, sku text NULL, product_name text NULL, qty_on_hand numeric(14, 4) NULL, max_expiry_date date NULL, last_movement_at timestamptz NULL);

-- Permissions

ALTER TABLE pharmacy.vw_t_inventory_stock OWNER TO postgres;
GRANT ALL ON TABLE pharmacy.vw_t_inventory_stock TO postgres;


-- pharmacy.vw_t_sale_items_detail definition

-- Drop table

-- DROP TABLE pharmacy.vw_t_sale_items_detail;

CREATE TABLE pharmacy.vw_t_sale_items_detail ( sale_item_id int8 NULL, sale_id int8 NULL, product_id int8 NULL, product_name text NULL, lot_id int8 NULL, qty numeric(14, 4) NULL, unit_price numeric(14, 4) NULL, discount numeric(14, 2) NULL, tax_amount numeric(14, 2) NULL, line_total numeric(14, 2) NULL);

-- Permissions

ALTER TABLE pharmacy.vw_t_sale_items_detail OWNER TO postgres;
GRANT ALL ON TABLE pharmacy.vw_t_sale_items_detail TO postgres;


-- pharmacy.vw_t_sales_daily_summary definition

-- Drop table

-- DROP TABLE pharmacy.vw_t_sales_daily_summary;

CREATE TABLE pharmacy.vw_t_sales_daily_summary ( "day" timestamptz NULL, sales_count int8 NULL, subtotal numeric(14, 2) NULL, tax_total numeric(14, 2) NULL, discount_total numeric(14, 2) NULL, total numeric(14, 2) NULL, total_credit numeric(14, 2) NULL);

-- Permissions

ALTER TABLE pharmacy.vw_t_sales_daily_summary OWNER TO postgres;
GRANT ALL ON TABLE pharmacy.vw_t_sales_daily_summary TO postgres;


-- pharmacy.vw_t_sales_with_payments definition

-- Drop table

-- DROP TABLE pharmacy.vw_t_sales_with_payments;

CREATE TABLE pharmacy.vw_t_sales_with_payments ( id int8 NULL, invoice_no text NULL, "date" timestamptz NULL, customer_id int8 NULL, customer_name text NULL, user_id int8 NULL, user_name text NULL, subtotal numeric(14, 2) NULL, tax_total numeric(14, 2) NULL, discount_total numeric(14, 2) NULL, total numeric(14, 2) NULL, status text NULL, is_credit bool NULL, paid_amount numeric(14, 2) NULL, allocated_amount numeric(14, 2) NULL, outstanding numeric(14, 2) NULL);

-- Permissions

ALTER TABLE pharmacy.vw_t_sales_with_payments OWNER TO postgres;
GRANT ALL ON TABLE pharmacy.vw_t_sales_with_payments TO postgres;
...
-- DROP FUNCTION pharmacy.fn_t_best_sellers_30d(int4, int8, timestamptz, timestamptz);

CREATE OR REPLACE FUNCTION pharmacy.fn_t_best_sellers_30d(p_days integer DEFAULT 30, p_product_id bigint DEFAULT 0, p_start timestamp with time zone DEFAULT NULL::timestamp with time zone, p_end timestamp with time zone DEFAULT NULL::timestamp with time zone)
 RETURNS void
 LANGUAGE plpgsql
AS $function$
DECLARE
...
ALTER FUNCTION pharmacy.fn_t_best_sellers_30d(int4, int8, timestamptz, timestamptz) OWNER TO postgres;
GRANT ALL ON FUNCTION pharmacy.fn_t_best_sellers_30d(int4, int8, timestamptz, timestamptz) TO postgres;

-- DROP FUNCTION pharmacy.fn_t_cash_journal_balance(int8, timestamptz, timestamptz);

CREATE OR REPLACE FUNCTION pharmacy.fn_t_cash_journal_balance(p_cash_journal_id bigint DEFAULT 0, p_start timestamp with time zone DEFAULT NULL::timestamp with time zone, p_end timestamp with time zone DEFAULT NULL::timestamp with time zone)
 RETURNS void
 LANGUAGE plpgsql
AS $function$
BEGIN
...
ALTER FUNCTION pharmacy.fn_t_cash_journal_balance(int8, timestamptz, timestamptz) OWNER TO postgres;
GRANT ALL ON FUNCTION pharmacy.fn_t_cash_journal_balance(int8, timestamptz, timestamptz) TO postgres;

-- DROP FUNCTION pharmacy.fn_t_customer_account_summary(int8, timestamptz, timestamptz);

CREATE OR REPLACE FUNCTION pharmacy.fn_t_customer_account_summary(p_customer_id bigint DEFAULT 0, p_start timestamp with time zone DEFAULT NULL::timestamp with time zone, p_end timestamp with time zone DEFAULT NULL::timestamp with time zone)
 RETURNS void
 LANGUAGE plpgsql
AS $function$
BEGIN
...
ALTER FUNCTION pharmacy.fn_t_customer_account_summary(int8, timestamptz, timestamptz) OWNER TO postgres;
GRANT ALL ON FUNCTION pharmacy.fn_t_customer_account_summary(int8, timestamptz, timestamptz) TO postgres;

-- DROP FUNCTION pharmacy.fn_t_customer_invoice_aging(int8, date);

CREATE OR REPLACE FUNCTION pharmacy.fn_t_customer_invoice_aging(p_customer_id bigint DEFAULT 0, p_as_of date DEFAULT NULL::date)
 RETURNS void
 LANGUAGE plpgsql
AS $function$
DECLARE
...
ALTER FUNCTION pharmacy.fn_t_customer_invoice_aging(int8, date) OWNER TO postgres;
GRANT ALL ON FUNCTION pharmacy.fn_t_customer_invoice_aging(int8, date) TO postgres;

-- DROP FUNCTION pharmacy.fn_t_daily_cash_cut(timestamptz, timestamptz, text);

CREATE OR REPLACE FUNCTION pharmacy.fn_t_daily_cash_cut(p_start timestamp with time zone DEFAULT NULL::timestamp with time zone, p_end timestamp with time zone DEFAULT NULL::timestamp with time zone, p_status text DEFAULT NULL::text)
 RETURNS void
 LANGUAGE plpgsql
AS $function$
BEGIN
...
ALTER FUNCTION pharmacy.fn_t_daily_cash_cut(timestamptz, timestamptz, text) OWNER TO postgres;
GRANT ALL ON FUNCTION pharmacy.fn_t_daily_cash_cut(timestamptz, timestamptz, text) TO postgres;

-- DROP FUNCTION pharmacy.fn_t_inventory_stock(int8);

CREATE OR REPLACE FUNCTION pharmacy.fn_t_inventory_stock(p_product_id bigint DEFAULT 0)
 RETURNS void
 LANGUAGE plpgsql
AS $function$
BEGIN
...
ALTER FUNCTION pharmacy.fn_t_inventory_stock(int8) OWNER TO postgres;
GRANT ALL ON FUNCTION pharmacy.fn_t_inventory_stock(int8) TO postgres;

-- DROP FUNCTION pharmacy.fn_t_sale_items_detail(int8, int8, timestamptz, timestamptz);

CREATE OR REPLACE FUNCTION pharmacy.fn_t_sale_items_detail(p_sale_id bigint DEFAULT 0, p_product_id bigint DEFAULT 0, p_start timestamp with time zone DEFAULT NULL::timestamp with time zone, p_end timestamp with time zone DEFAULT NULL::timestamp with time zone)
 RETURNS void
 LANGUAGE plpgsql
AS $function$
BEGIN
...
ALTER FUNCTION pharmacy.fn_t_sale_items_detail(int8, int8, timestamptz, timestamptz) OWNER TO postgres;
GRANT ALL ON FUNCTION pharmacy.fn_t_sale_items_detail(int8, int8, timestamptz, timestamptz) TO postgres;

-- DROP FUNCTION pharmacy.fn_t_sales_daily_summary(timestamptz, timestamptz, int8, int8, text);

CREATE OR REPLACE FUNCTION pharmacy.fn_t_sales_daily_summary(p_start timestamp with time zone DEFAULT NULL::timestamp with time zone, p_end timestamp with time zone DEFAULT NULL::timestamp with time zone, p_customer_id bigint DEFAULT 0, p_user_id bigint DEFAULT 0, p_status text DEFAULT NULL::text)
 RETURNS void
 LANGUAGE plpgsql
AS $function$
BEGIN
...
ALTER FUNCTION pharmacy.fn_t_sales_daily_summary(timestamptz, timestamptz, int8, int8, text) OWNER TO postgres;
GRANT ALL ON FUNCTION pharmacy.fn_t_sales_daily_summary(timestamptz, timestamptz, int8, int8, text) TO postgres;

-- DROP FUNCTION pharmacy.fn_t_sales_with_payments(int8, int8, int8, timestamptz, timestamptz, bool, text);

CREATE OR REPLACE FUNCTION pharmacy.fn_t_sales_with_payments(p_sale_id bigint DEFAULT 0, p_customer_id bigint DEFAULT 0, p_user_id bigint DEFAULT 0, p_start timestamp with time zone DEFAULT NULL::timestamp with time zone, p_end timestamp with time zone DEFAULT NULL::timestamp with time zone, p_is_credit boolean DEFAULT NULL::boolean, p_status text DEFAULT NULL::text)
 RETURNS void
 LANGUAGE plpgsql
AS $function$
BEGIN
...
ALTER FUNCTION pharmacy.fn_t_sales_with_payments(int8, int8, int8, timestamptz, timestamptz, bool, text) OWNER TO postgres;
GRANT ALL ON FUNCTION pharmacy.fn_t_sales_with_payments(int8, int8, int8, timestamptz, timestamptz, bool, text) TO postgres;
